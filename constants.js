...
// ResetCommand Edit
	global.CON_RESETEDIT_COMMANDTYPE = 400;
	global.CON_RESETEDIT_NPC = 401;
	global.CON_RESETEDIT_NPC_MAX_ALLOWED = 402;
	global.CON_RESETEDIT_NPC_ROOMID = 403;
	global.CON_RESETEDIT_ITEM = 410;
	global.CON_RESETEDIT_ITEM_MAX_ALLOWED = 411;
	global.CON_RESETEDIT_ITEM_ROOMID = 412;
	global.CON_RESETEDIT_PUTITEMINITEM = 420;
	global.CON_RESETITEM_PUTITEMINITEM_MAX_ALLOWED = 421;
	global.CON_RESETEDIT_NPCVENDING_ITEM = 430;
	global.CON_RESETEDIT_NPCVENDING_MAX_ALLOWED = 431;
	global.CON_RESETEDIT_DESCRIPTION = 499;
